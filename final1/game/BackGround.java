...
import com.example.user.final2.framework.GraphicObject;
...
public class BackGround extends GraphicObject {
    ...
    //            m_bitmap = Bitmap.createScaledBitmap(AppManager.getInstance().getBitmap(R.drawable.background1),w,h,true);
