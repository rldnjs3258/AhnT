...
public class Player extends SpriteAnimation {
    ...
    public Player (Bitmap bitmap){ //플레이어의 위치와 설정을 세팅한다.
        super(bitmap);
        //애니메이션 정보 설정
        this.initSpriteData(getBitmapWidth()/6, getBitmapHeight(), 10, 6); //프레임 나누기
        this.setPosition(300, 1200); //초기 위치값 설정
    }
    ...
    public void Update(long gameTime){
        ...
        m_BoundBox.set(m_x, m_y, m_x+getBitmapWidth()/6-20, m_y+getBitmapHeight()-20);
    }
}